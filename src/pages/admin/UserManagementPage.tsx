...
const MOCK_USERS: User[] = [
    { id: '1', name: 'Anna Kowalska', email: 'anna@ecm.com', role: 'ADMIN', lastActive: '2025-10-22' },
    { id: '2', name: 'Piotr Nowak', email: 'piotr@ecm.com', role: 'MANAGER', lastActive: '2025-10-23' },
    { id: '3', name: 'Katarzyna Lewa', email: 'kasia@ecm.com', role: 'SALES', lastActive: '2025-10-21' },
    { id: '4', name: 'Marcin Wójcik', email: 'marcin@ecm.com', role: 'USER', lastActive: '2025-10-23' },
    { id: '5', name: 'Zofia Zielińska', email: 'zofia@ecm.com', role: 'USER', lastActive: '2025-10-20' },
];
